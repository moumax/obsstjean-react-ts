...
const LocationsManager = {
  async getAll() {
    try {
      ...
      console.error('Erreur lors de la récupération des lieux:', err.message)
      throw err
    }
  },
  ...
  async create(location) {
    try {
      ...
      console.error('Erreur lors de la création du nouveau lieu :', err.message)
      throw err
    }
  },
  ...
  async update(location, id) {
    try {
      ...
      console.error('Erreur lors de la mise à jour du lieu :', err.message)
      throw err
    }
  },
