...
const CamerasManager = {
  async getAll() {
    try {
      ...
      console.error('Erreur lors de la récupération des cameras:', err.message)
      throw err
    }
  },
  ...
  async create(camera) {
    try {
      ...
      console.error('Erreur lors de la création de la camera :', err.message)
      throw err
    }
  },
  ...
  async update(camera, id) {
    try {
      ...
      console.error('Erreur lors de la mise à jour de la camera :', err.message)
      throw err
    }
  },
